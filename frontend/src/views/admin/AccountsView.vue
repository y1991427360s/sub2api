<template>
  <AppLayout>
        ...
        >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button @click="handleCopy(row)" class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-blue-900/20 dark:hover:text-blue-400">
                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125H4.875A1.125 1.125 0 013.75 20.625V8.625c0-.621.504-1.125 1.125-1.125H8.25m7.5 9.75H19.125c.621 0 1.125-.504 1.125-1.125V4.125C20.25 3.504 19.746 3 19.125 3H9.375c-.621 0-1.125.504-1.125 1.125V7.5m7.5 9.75H9.375A1.125 1.125 0 018.25 16.125V7.5m7.5 9.75l-7.5-9.75" /></svg>
    ...
    <CreateAccountModal :show="showCreate" :proxies="proxies" :groups="groups" :prefill-account="copySourceAcc" @close="handleCreateClose" @created="handleAccountCreated" />
...
const copySourceAcc = ref<Account | null>(null)
...
const handleCopy = (a: Account) => {
  copySourceAcc.value = a
  showCreate.value = true
}
const handleCreateClose = () => {
  showCreate.value = false
  copySourceAcc.value = null
}
